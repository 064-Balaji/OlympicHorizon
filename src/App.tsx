...
const App = () => {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""} min-h-screen w-svw`}>
      <div className="min-h-screen bg-light dark:bg-dark text-dark dark:text-light flex flex-col">
            ...
            <ul className="flex space-x-6 text-gray-700 dark:text-gray-300">
              ...
              <li>
                <button
                  ...
                  className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200"
                >
                  {darkMode ? (
        ...
        <footer className="bg-primary dark:bg-dark text-light dark:text-primary py-6">
